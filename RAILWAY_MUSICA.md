...
## Sincronización vista previa ↔ overlay
La simulación del widget de música ya no publica `playing:true` antes de que el reproductor de YouTube comience realmente. El overlay recibe el reloj autoritativo cuando el IFrame confirma `PLAYING`, `PAUSED` o `ENDED`, usando el tiempo actual del mismo reproductor.
